...
: lll
begin
left? xin can.jump? and if s.up xin set.dir then
enemy enemy.left
xin update.square
lcd.update
10 ms
xin enemy collided? until
;

: jjj 
#15 #30 xin pos.square
xin fill.square

#75 #30 enemy pos.square
enemy fill.square
begin
right? xin can.jump? and if s.up xin set.dir then
enemy enemy.left
xin update.square
lcd.update
10 ms
